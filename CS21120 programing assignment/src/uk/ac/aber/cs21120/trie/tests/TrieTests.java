...
public class TrieTests {
     ...
     * the hash set tests! JUnit makes it quite difficult to do anything more sensible with
     * inheritance.
     * @return a new trie
     */
    ...
    /**
     * Words used in the contents() tests.
     */
     ...
     * We can build tests against that structure.
     */
    @Test
